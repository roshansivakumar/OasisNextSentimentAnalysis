...
load("ouath")
#---------------------
getpagedata<-getPage(page = 32075534692,token =ouath,since ='2016/11/08' ,until ='2017/11/08',n=5000)
getpagedata1<-getPage(page = 32075534692,token =ouath,since ='2016/11/08' ,until ='2017/02/08',n=5000)
getpagedata2<-getPage(page = 32075534692,token =ouath,since ='2017/02/08' ,until ='2017/05/08',n=5000)
getpagedata3<-getPage(page = 32075534692,token =ouath,since ='2017/05/08' ,until ='2017/08/08',n=5000)
getpagedata4<-getPage(page = 32075534692,token =ouath,since ='2017/08/08' ,until ='2017/11/09',n=5000)
View(getpagedata)
View(getpagedata1)
View(getpagedata2)
View(getpagedata3)
...
while(j<=nrow(getpagedata1))
{
  ...
  getreaction1 <- getReactions(post=getpagedata1$id[j], token=ouath)
...
#   });
# }
 write.csv(df,"oasisTimelineComments.csv")
 write.csv(dfr,"oasisTimelineReactions.csv")
 write.csv(df1,"oasisInterval1Comments.csv")
 write.csv(dfr1,"oasisInterval1Reactions.csv")
 write.csv(df2,"oasisInterval2Comments.csv")
 write.csv(dfr2,"oasisInterval2Reactions.csv")
 write.csv(df3,"oasisInterval3Comments.csv")
 write.csv(dfr3,"oasisInterval3Reactions.csv")
 write.csv(df4,"oasisInterval4Comments.csv")
 write.csv(dfr4,"oasisInterval4Reactions.csv")
